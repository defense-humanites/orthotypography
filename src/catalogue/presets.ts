...
export const PRESETS: readonly PresetDefinition[] = [
  {
    ...
    rules: [
      ...
      { ruleId: "punctuation.period.space-after", mode: "manual-review" },
      { ruleId: "punctuation.colon.space-after", mode: "manual-review" },
      { ruleId: "punctuation.semicolon.nnbsp-before" },
      { ruleId: "punctuation.semicolon.space-after", mode: "manual-review" },
      { ruleId: "punctuation.question.nnbsp-before" },
      { ruleId: "punctuation.question.space-after", mode: "manual-review" },
      { ruleId: "punctuation.exclamation.nnbsp-before" },
      { ruleId: "punctuation.exclamation.space-after", mode: "manual-review" },
